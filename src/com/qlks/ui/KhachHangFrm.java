...
public class KhachHangFrm extends javax.swing.JInternalFrame {
                            ...
                            .addGroup(jPanel4Layout.createSequentialGroup()
                                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(jPanel4Layout.createSequentialGroup()
                                        ...
                                        .addGap(18, 18, 18)
                                        .addComponent(rdoNu))
                                    .addComponent(txtDiaChi, javax.swing.GroupLayout.PREFERRED_SIZE, 501, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addComponent(txtQuocTich, javax.swing.GroupLayout.PREFERRED_SIZE, 501, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private KhachHang getFormUpdate() {
        ...
        if (Validator.checkBlack(this, title, txtTenKH, txtCMND, txtSDT, txtDiaChi, txtQuocTich)
                && Validator.checkIdentityCard(this, txtCMND)
                && Validator.isExists(this, txtCMND, khdao.selectCmnd1(kh1.getSdt()), "CMND")
                && Validator.checkPhoneNum(this, txtSDT)
                && Validator.isExists(this, txtSDT, khdao.selectSdt1(kh1.getCmnd()), "SDT")) {
            String ten = txtTenKH.getText().trim();
            String cmnd = txtCMND.getText().trim();
            String sdt = txtSDT.getText().trim();
            boolean gioiTinh = rdoNam.isSelected() ? true : false;
