...
GO
DELETE FROM GIA
DBCC CHECKIDENT ('GIA', RESEED, 0)
INSERT GIA VALUES (N'Giá theo giờ')
INSERT GIA VALUES (N'Giá qua đêm')
INSERT GIA VALUES (N'Giá theo ngày')
SELECT * FROM GIA
GO
...
---------------------------------------LOAIPHONG_GIA
IF OBJECT_ID ('LOAIPHONG_GIA') IS NOT NULL
DROP TABLE LOAIPHONG_GIA
GO
CREATE TABLE LOAIPHONG_GIA
(
	ID		INT IDENTITY(1,1) NOT NULL PRIMARY KEY,
...
GO
DELETE FROM LOAIPHONG_GIA
DBCC CHECKIDENT ('LOAIPHONG_GIA', RESEED, 0)
INSERT LOAIPHONG_GIA VALUES ('STD', 1, 50)
INSERT LOAIPHONG_GIA VALUES ('STD', 2, 100)
INSERT LOAIPHONG_GIA VALUES ('STD', 3, 80)

INSERT LOAIPHONG_GIA VALUES ('SUP', 1, 80)
INSERT LOAIPHONG_GIA VALUES ('SUP', 2, 120)
INSERT LOAIPHONG_GIA VALUES ('SUP', 3, 100)

INSERT LOAIPHONG_GIA VALUES ('DLX', 1, 120)
INSERT LOAIPHONG_GIA VALUES ('DLX', 2, 160)
INSERT LOAIPHONG_GIA VALUES ('DLX', 3, 140)

INSERT LOAIPHONG_GIA VALUES ('SUT', 1, 160)
INSERT LOAIPHONG_GIA VALUES ('SUT', 2, 200)
INSERT LOAIPHONG_GIA VALUES ('SUT', 3, 180)

SELECT * FROM LOAIPHONG_GIA
GO
...
(
	...
	SOLUONG		INT NOT NULL
	UNIQUE(MAHDTT, MADV),
	FOREIGN KEY (MAHDTT) REFERENCES HOADON(MAHD),
