...
DELETE FROM PHONG
INSERT PHONG VALUES ('101', 4, 200000, 1, 'STD', DEFAULT, DEFAULT, DEFAULT)
INSERT PHONG VALUES ('102', 4, 200000, 1, 'STD', DEFAULT, DEFAULT, DEFAULT)
INSERT PHONG VALUES ('103', 2, 200000, 1, 'STD', DEFAULT, DEFAULT, DEFAULT)
INSERT PHONG VALUES ('304', 4, 1000000, 1, 'DLX', DEFAULT, DEFAULT, DEFAULT)
INSERT PHONG VALUES ('205', 4, 200000, 1, 'SUP', DEFAULT, DEFAULT, DEFAULT)
INSERT PHONG VALUES ('206', 4, 200000, 1, 'SUP', DEFAULT, DEFAULT, DEFAULT)
GO
SELECT * FROM PHONG
...
(
	...
	NGAYSINH		DATE CHECK ((YEAR(GETDATE()) - YEAR(NGAYSINH)) BETWEEN 18 AND 65),
	GIOITINH		BIT NOT NULL,
	DIACHI			NVARCHAR(50) NOT NULL,
	SDT				VARCHAR(20) NOT NULL UNIQUE,
	EMAIL			VARCHAR(50) NOT NULL UNIQUE,
	ANH				VARCHAR(50) DEFAULT 'AVATAR_DEFAULT',
...
INSERT KHACHHANG VALUES (N'Khách hàng 1', '122122121', '0987654001', 1, N'Hà Nội', DEFAULT, DEFAULT, DEFAULT)
INSERT KHACHHANG VALUES (N'Khách hàng 2', '122122122', '0987654002', 0, N'TP Hồ Chí Minh', DEFAULT, DEFAULT, DEFAULT)
INSERT KHACHHANG VALUES (N'Khách hàng 3', '122122123', '0987654003', 1, N'Đà Nẵng', DEFAULT, DEFAULT, DEFAULT)
GO
...
INSERT NCC_SDT VALUES (1, '0999888115')
GO
SELECT * FROM NCC_SDT
...
INSERT PHONG_TIENNGHI VALUES ('103', 4, 1, 'Normal')
...
INSERT PHONG_TIENNGHI VALUES ('304', 4, 1, 'Normal')
GO
